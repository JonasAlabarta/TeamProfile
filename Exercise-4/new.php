...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $motto = $_POST['motto'] ?? 'No motto provided.';
    ...
    if (isset($_FILES['image']) && $_FILES['image']['error'] == UPLOAD_ERR_OK) {
        ...
        $imageDestPath = './default.jpg';
    }
} elseif ($_SERVER['REQUEST_METHOD'] === 'GET') {
    $name = $_GET['name'] ?? 'Default Name';
    $nickName = $_GET['nickName'] ?? 'Nickname';
    $motto = $_GET['motto'] ?? 'No motto provided.';
...
<?php 
    ...
    ?>
    <a id="post-member" href="form.php" target="_blank">Add member (POST METHOD)</a><br>
    <a id="get-member" href="form2.php" target="_blank">Add member (GET METHOD)</a>
    <div class="container">
        <div class="left-side">
            <div class="left-image">
                <img src="<?php echo htmlspecialchars($leftImageSrc); ?>" alt="Profile image">
                <h1 id="left-name"><?php echo htmlspecialchars($leftName); ?></h1>
                <p>
                    <a id="left-link" href="<?php echo htmlspecialchars($leftLinkedinUrl); ?>" target="_blank">LinkedIn</a>
                </p>
                <p id="left-quote">
                    <?php echo htmlspecialchars($leftQuote); ?>
                </p>
            </div>
        </div>
        <div class="right-side">
            ...
            <div class="mycard">
                ...
                <div class="card" onclick="updateLeftSide('<?php echo htmlspecialchars($imageDestPath); ?>', '<?php echo htmlspecialchars($name); ?>', '<?php echo htmlspecialchars($linkedIn); ?>', '<?php echo htmlspecialchars($motto); ?>')">
                    <div class="card-image">
                        <img src="<?php echo htmlspecialchars($imageDestPath); ?>" alt="Profile image">
                    </div>
    ...
    <script>
        function updateLeftSide(imageSrc, name, linkedinUrl, quote) {
            console.log('Updating with:', imageSrc, name, linkedinUrl, quote);
